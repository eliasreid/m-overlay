function love.conf(t)
	...
	--TODO: fix issue where settings jump from top of window to center of window (when I hack the height like this)
	-- Ideally winow is user-resizeable, but only for height
	t.window.minheight = 1300            -- Minimum window height if the window is resizable (number)
